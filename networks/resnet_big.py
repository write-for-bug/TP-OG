...
class StandardResnet_CIFAR(nn.Module):
    def __init__(self, name='resnet18', dataset='cifar10'):
        super(StandardResnet_CIFAR, self).__init__()
...
class StandardResnetEnergy_CIFAR(nn.Module):
    def __init__(self, name='resnet18', dataset='cifar10'):
        super(StandardResnetEnergy_CIFAR, self).__init__()
        model_fun, dim_in = model_dict[name]
        self.encoder = model_fun()
        if dataset == 'cifar10':
...
class SupStandardResnet_Normal_CIFAR(nn.Module):
    def __init__(self, name='resent18', dataset='cifar10'):
        super(SupStandardResnet_Normal_CIFAR, self).__init__()
        model_fun, dim_in = model_dict[name]
        self.encoder = model_fun()
        self.projection = nn.Sequential(
            nn.Linear(dim_in, dim_in),
